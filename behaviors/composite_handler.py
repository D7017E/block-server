...
# type: (ArmGesture, HeadGesture, PepperSpeech, PepperExpression, HipGesture) -> CompositeHandler
    ...
    def macarena_dance(self):
        """
        Makes Pepper do the macarena.
        """
        ...
        self.arms.rotate_right_shoulder_pitch(100, 0)
        time.sleep(1)
        self.arms.rotate_left_elbow_yaw(100, -119.5)
        time.sleep(1)
        self.arms.rotate_right_elbow_yaw(100, 119.5)
        time.sleep(1)
        self.arms.rotate_left_elbow_yaw(100, -30)
        self.arms.rotate_left_elbow_roll(100, -89.5)
        time.sleep(1)
        self.arms.rotate_right_elbow_yaw(100, -30)
        self.arms.rotate_right_elbow_roll(100, 50)
        time.sleep(1)
        self.arms.rotate_left_shoulder_roll(100, 89.5)
        self.arms.rotate_left_elbow_yaw(100, -90)
        self.arms.rotate_left_elbow_roll(100, -89.5)
        ...
        self.arms.rotate_right_shoulder_roll(100, -89.5)
        self.arms.rotate_right_elbow_yaw(100, 90)
        self.arms.rotate_right_elbow_roll(100, 89.5)
        time.sleep(1)
        self.arms.rotate_left_shoulder_roll(100, 0.5)
        self.arms.rotate_left_shoulder_pitch(100, 60)
        self.arms.rotate_left_elbow_roll(100, -30)
        self.arms.rotate_left_elbow_yaw(100, 0)
        time.sleep(1)
        self.arms.rotate_right_shoulder_roll(100, -0.5)
        self.arms.rotate_right_shoulder_pitch(100, 60)
        self.arms.rotate_right_elbow_roll(100, 30)
        self.arms.rotate_right_elbow_yaw(100, 0)
        time.sleep(1)
        self.hips.rotate_hip_roll(100, -15)
        time.sleep(1)
        self.hips.rotate_hip_pitch(100, 10)
        time.sleep(1)
        self.hips.rotate_hip_roll(100, 15)
        time.sleep(1)
        self.hips.rotate_hip_pitch(100, -10)
        time.sleep(1)
        self.hips.rotate_hip_roll(100, 0)
        time.sleep(1)
        self.arms.reset_arms()
